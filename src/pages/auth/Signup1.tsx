...
interface DoctorSignUpForm {
  ...
  const SignUp: React.FC = () => {
    const { register, handleSubmit, formState: { errors }, watch } = useForm<DoctorSignUpForm>();
    const navigate = useNavigate();
    const [isLoading, setIsLoading] = useState(false);
    const password = watch('password');
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Register to manage your sessions
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="doctorId" className="text-sm font-medium text-gray-700">Doctor ID</label>
                <input
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="e.g., Therapist, Psychologist"
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                />
